   ...
   * up to 128 seconds.
	...
	var Client = function (host, port, path, clientId) {
	    ...
	    if (arguments.length == 2) {
			...
			uri = "mqtt://"+(ipv6AddSBracket?"["+host+"]":host)+":"+port+path;
		}
     ...
     * @param {array} connectOptions.hosts - If present this contains either a set of hostnames or fully qualified
		 * WebSocket URIs (mqtt://iot.eclipse.org:80/ws), that are tried in order in place
     ...
     * (e.g. mqtt://iot.eclipse.org:80/ws), that are tried in order in place of the host and port parameter of the construtor.
