...
<html>
  <head>
    <title>แสดงตำแหน่งปัจจุบัน</title>
          ...
          if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
              (position) => {
                ...
                infoWindow.setContent("ตำแหน่งปัจุบันของคุณ");
                infoWindow.open(map);
                map.setCenter(pos);
              },
              () => {
...
<?php /**PATH C:\xampp\htdocs\Test\example-app\resources\views/location.blade.php ENDPATH**/ ?>